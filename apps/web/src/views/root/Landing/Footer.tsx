  ...
  return (
    <footer className="bg-[#FDFDFD] pt-28 pb-20 relative flex flex-col items-center">
      ...
      <div className="w-full max-w-6xl mx-auto px-6 lg:px-0 relative z-10">
        ...
        {/* Second Line (Bottom Links) */}
        <div className="relative border-t border-slate-100 pt-10 pb-2">
          {/* Junction Circles */}
          <div className="absolute -left-[5px] -top-[5px] w-2.5 h-2.5 bg-white border border-slate-200 rounded-full" />
          <div className="absolute -right-[5px] -top-[5px] w-2.5 h-2.5 bg-white border border-slate-200 rounded-full" />
          <div className="absolute -left-[5px] -bottom-[4px] w-2.5 h-2.5 bg-white border border-slate-200 rounded-full" />
          <div className="absolute -right-[5px] -bottom-[4px] w-2.5 h-2.5 bg-white border border-slate-200 rounded-full" />

          {/* Bottom Border to close the grid row */}
          <div className="absolute inset-x-0 bottom-0 h-[1px] bg-slate-100" />

          <div className="flex flex-wrap justify-center gap-x-6 gap-y-4 text-[14px]">
